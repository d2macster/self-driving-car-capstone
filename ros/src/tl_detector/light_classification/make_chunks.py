# script from Team Vulture
# https://github.com/diyjac/SDC-System-Integration/blob/master/classifier/faster-R-CNN/makechunks.py
# python 2.7
import os
import sys
...
splitfile('./frozen_inference_graph.pb', 'frozen_model_chunks')